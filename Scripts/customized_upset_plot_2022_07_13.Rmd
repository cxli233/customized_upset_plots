...
upperleft <- total %>% 
  ...
  scale_fill_manual(values = brewer.pal(4, "Set2"),  
                     limits = c("data1", "data2", "data3", "data4")) + 
...
ggsave("../Results/upset_full.svg", height = 7, width = 3.5) 
...
ggsave("../Results/upset_full.png", height = 7, width = 3.5)
```
...
ggsave("../Results/upset_3only.svg", height = 4.5, width = 3.5) # this time the plot can be shorter 
# the best aspect ratio is when the grids in the colored matrix are perfect squares 
ggsave("../Results/upset_3only.png", height = 4.5, width = 3.5) 
```
...
intersection_data <- rbind(
  ...
  inner_join(element_values, by = c("."="elements")) %>% 
  rename(elements = ".") %>% 
  rbind(overlap_sizes %>% 
...
ggsave("../Results/upset_extended.svg", height = 7, width = 6) # this time the plot needs to be wider
ggsave("../Results/upset_extended.png", height = 7, width = 6) 
```
