...
ggsave("../Results/upset_full.svg", height = 7, width = 3.5, bg = "white") 
...
ggsave("../Results/upset_full.png", height = 7, width = 3.5, bg = "white")
```
...
ggsave("../Results/upset_extended.svg", height = 7, width = 6, bg = "white") 
# this time the plot needs to be wider
ggsave("../Results/upset_extended.png", height = 7, width = 6, bg = "white") 
```
