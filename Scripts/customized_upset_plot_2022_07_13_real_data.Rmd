...
ggsave("../Results/real_data_upset_full.svg", height = 7, width = 3.5) 
...
ggsave("../Results/real_data_upset_full.png", height = 7, width = 3.5)
```
...
ggsave("../Results/real_data_upset_3only.svg", height = 4.5, width = 3.5) # this time the plot can be shorter 
# the best aspect ratio is when the grids in the colored matrix are perfect squares 
ggsave("../Results/real_data_upset_3only.png", height = 4.5, width = 3.5) 
```
...
ggsave("../Results/real_data_upset_extended.svg", height = 7, width = 6) # this time the plot needs to be wider
ggsave("../Results/real_data_upset_extended.png", height = 7, width = 6) 
```
